...
const TokenLockCard: React.FC<TokenLockCardProps> = ({
  token,
  lock,
  unlock,
}) => {
        ...
        <div className="flex flex-row items-center space-x-3">
          <div className="avatar">
            <div className="rounded-full w-14 h-14 card-shadow bg-black">
              <img src={token.iconSrc} alt={`${token.name} Icon`} />
            </div>
          </div>
          <div className="overflow-scroll w-[55%]">{token.name}</div>
        </div>
